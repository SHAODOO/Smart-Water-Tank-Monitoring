...
const char* smartWaterTankMonitoringId = "904d75d0-007c-4b00-9ee3-de6b3456c640";
...
{    
  ...
  if (!voneClient.connected()) {
    ...
    voneClient.publishDeviceStatusEvent(smartWaterTankMonitoringId, true);
  }
  voneClient.loop();
  ...
  if (cur - lastMsgTime > INTERVAL) {
    ...
    JSONVar payloadObject1, payloadObject2;
    payloadObject1["Humidity"] = humidity;
    payloadObject1["Temperature"] = temperature;
    payloadObject2["Humidity"] = humidity;
    payloadObject2["Temperature"] = temperature;
    payloadObject2["pH"] = waterPh;
    payloadObject2["Water level"] = waterLevel;
    voneClient.publishTelemetryData(dhtSensorId, payloadObject1);
    ...
    voneClient.publishTelemetryData(smartWaterTankMonitoringId, payloadObject2);
    delay(15000);
  }
}