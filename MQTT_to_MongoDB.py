...
# MongoDB configuration mongo_client = pymongo.MongoClient("mongodb://localhost:27017/") 
db = mongo_client["SmartWaterTankMonitoring"] 
collection = db["iot"]  

# MQTT configuration 
mqtt_broker_address = '35.240.197.170' 
mqtt_topic = 'iot'  
